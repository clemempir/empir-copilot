 ...
 * Consommé par __corpus.live.test.ts (vérification) et par
 * collector/replay-corpus.mts (rapport détaillé des confiances).
 */
...
export const CASES: Case[] = [
  ...
  {
    name: "Général de Gaulle — maison 161 E/301 GES E/58, disque ville 2500 m : conso annoncée ≠ cert (301 vs 292,4, ressaisie agence) mais GES 58 EXACT et unique → l'empreinte GES corrobore le scoring, 78 → 83 % (Leboncoin 3195763796, parcellai.re 100 %, 2026-07-07)",
    input: {
      postalCode: "40500", city: "Saint-Sever", surface: 161, rooms: 5, landSurface: 414,
      dpeClass: "E", dpeKwhM2: 301, gesClass: "E", gesKgCO2M2: 58, propertyType: "Maison",
